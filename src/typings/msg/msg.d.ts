...
declare namespace Blockly.Msg {
  ...
  let COLOR_BLEND_COLOR1 : string ;
  let COLOR_BLEND_COLOR2 : string ;
  let COLOR_BLEND_HELPURL : string ;
  let COLOR_BLEND_RATIO : string ;
  let COLOR_BLEND_TITLE : string ;
  let COLOR_BLEND_TOOLTIP : string ;
  let COLOR_HUE : string ;
  let COLOR_PICKER_HELPURL : string ;
  let COLOR_PICKER_TOOLTIP : string ;
  let COLOR_RANDOM_HELPURL : string ;
  let COLOR_RANDOM_TITLE : string ;
  let COLOR_RANDOM_TOOLTIP : string ;
  let COLOR_RGB_BLUE : string ;
  let COLOR_RGB_GREEN : string ;
  let COLOR_RGB_HELPURL : string ;
  let COLOR_RGB_RED : string ;
  let COLOR_RGB_TITLE : string ;
  let COLOR_RGB_TOOLTIP : string ;
