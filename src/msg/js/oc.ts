...
Blockly.Msg["COLOR_BLEND_TITLE"] = "mesclar";
Blockly.Msg["COLOR_BLEND_TOOLTIP"] = "Blends two colors together with a given ratio (0.0 - 1.0).";  // untranslated
Blockly.Msg["COLOR_PICKER_HELPURL"] = "https://oc.wikipedia.org/wiki/Color";
Blockly.Msg["COLOR_PICKER_TOOLTIP"] = "Causir una color dins la paleta.";
Blockly.Msg["COLOR_RANDOM_HELPURL"] = "http://randomcolor.com";  // untranslated
Blockly.Msg["COLOR_RANDOM_TITLE"] = "color aleatòria";
Blockly.Msg["COLOR_RANDOM_TOOLTIP"] = "Causir una color a l'azard.";
...
Blockly.Msg["COLOR_RGB_RED"] = "roge";
Blockly.Msg["COLOR_RGB_TITLE"] = "coloriar amb";
...
Blockly.Msg["NEW_COLOR_VARIABLE"] = "Crear una variabla color…";
