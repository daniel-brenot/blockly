...
Blockly.Msg["COLOR_BLEND_COLOR1"] = "χρώμα 1";
Blockly.Msg["COLOR_BLEND_COLOR2"] = "χρώμα 2";
Blockly.Msg["COLOR_BLEND_HELPURL"] = "https://meyerweb.com/eric/tools/color-blend/#:::rgbp";
Blockly.Msg["COLOR_BLEND_RATIO"] = "αναλογία";
Blockly.Msg["COLOR_BLEND_TITLE"] = "μείγμα";
Blockly.Msg["COLOR_BLEND_TOOLTIP"] = "Συνδυάζει δύο χρώματα μαζί με μια δεδομένη αναλογία (0.0 - 1,0).";
Blockly.Msg["COLOR_PICKER_HELPURL"] = "https://en.wikipedia.org/wiki/Color";
Blockly.Msg["COLOR_PICKER_TOOLTIP"] = "Επιτρέπει επιλογή χρώματος από την παλέτα.";
Blockly.Msg["COLOR_RANDOM_HELPURL"] = "http://randomcolor.com";  // untranslated
Blockly.Msg["COLOR_RANDOM_TITLE"] = "τυχαίο χρώμα";
Blockly.Msg["COLOR_RANDOM_TOOLTIP"] = "Επιλέγει χρώμα τυχαία.";
Blockly.Msg["COLOR_RGB_BLUE"] = "μπλε";
Blockly.Msg["COLOR_RGB_GREEN"] = "πράσινο";
Blockly.Msg["COLOR_RGB_HELPURL"] = "https://www.december.com/html/spec/colorpercompact.html";
Blockly.Msg["COLOR_RGB_RED"] = "κόκκινο";
Blockly.Msg["COLOR_RGB_TITLE"] = "χρώμα με";
Blockly.Msg["COLOR_RGB_TOOLTIP"] = "Δημιουργήστε ένα χρώμα με την καθορισμένη ποσότητα κόκκινου, πράσινου και μπλε. Όλες οι τιμές πρέπει να είναι μεταξύ 0 και 100.";
...
Blockly.Msg["NEW_COLOR_VARIABLE"] = "Δημιουργία μεταβλητής χρώματος...";
