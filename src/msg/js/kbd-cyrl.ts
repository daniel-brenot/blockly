...
Blockly.Msg["COLOR_BLEND_COLOR1"] = "1 плъыфэ";
Blockly.Msg["COLOR_BLEND_COLOR2"] = "2 плъыфэ";
Blockly.Msg["COLOR_BLEND_HELPURL"] = "https://meyerweb.com/eric/tools/color-blend/#:::rgbp";  // untranslated
Blockly.Msg["COLOR_BLEND_RATIO"] = "1 плъыфэм щыщу";
Blockly.Msg["COLOR_BLEND_TITLE"] = "зэхэпщэн";
Blockly.Msg["COLOR_BLEND_TOOLTIP"] = "ПлъыфитIыр епт зэхущытыкIэмкIэ хэхэпщэн (0.0 - 1.0).";
Blockly.Msg["COLOR_PICKER_HELPURL"] = "https://ru.wikipedia.org/wiki/Цвет";
Blockly.Msg["COLOR_PICKER_TOOLTIP"] = "Плъыфэхэм узыхуейр къыхэх.";
Blockly.Msg["COLOR_RANDOM_HELPURL"] = "http://randomcolor.com";  // untranslated
Blockly.Msg["COLOR_RANDOM_TITLE"] = "сыт хуэдэ плъыфэми";
Blockly.Msg["COLOR_RANDOM_TOOLTIP"] = "Плъыфэр езыр-езыру къыхегъэхын.";
Blockly.Msg["COLOR_RGB_BLUE"] = "щIыхуу";
Blockly.Msg["COLOR_RGB_GREEN"] = "удзыфэу";
Blockly.Msg["COLOR_RGB_HELPURL"] = "https://www.december.com/html/spec/colorpercompact.html";  // untranslated
Blockly.Msg["COLOR_RGB_RED"] = "плъыжьу";
Blockly.Msg["COLOR_RGB_TITLE"] = "плъыфэхэм щыщ";
