...
Blockly.Msg["COLOR_BLEND_COLOR1"] = "цвет 1";
Blockly.Msg["COLOR_BLEND_COLOR2"] = "цвет 2";
Blockly.Msg["COLOR_BLEND_HELPURL"] = "https://meyerweb.com/eric/tools/color-blend/#:::rgbp";  // untranslated
Blockly.Msg["COLOR_BLEND_RATIO"] = "доля цвета 1";
Blockly.Msg["COLOR_BLEND_TITLE"] = "смешать";
Blockly.Msg["COLOR_BLEND_TOOLTIP"] = "Смешивает два цвета в заданном соотношении (0.0 - 1.0).";
Blockly.Msg["COLOR_PICKER_HELPURL"] = "https://ru.wikipedia.org/wiki/Цвет";
Blockly.Msg["COLOR_PICKER_TOOLTIP"] = "Выберите цвет из палитры.";
Blockly.Msg["COLOR_RANDOM_HELPURL"] = "http://randomcolor.com";  // untranslated
Blockly.Msg["COLOR_RANDOM_TITLE"] = "случайный цвет";
Blockly.Msg["COLOR_RANDOM_TOOLTIP"] = "Выбирает цвет случайным образом.";
Blockly.Msg["COLOR_RGB_BLUE"] = "синего";
Blockly.Msg["COLOR_RGB_GREEN"] = "зелёного";
Blockly.Msg["COLOR_RGB_HELPURL"] = "https://www.december.com/html/spec/colorpercompact.html";  // untranslated
Blockly.Msg["COLOR_RGB_RED"] = "красного";
Blockly.Msg["COLOR_RGB_TITLE"] = "цвет из";
Blockly.Msg["COLOR_RGB_TOOLTIP"] = "Создаёт цвет с указанной пропорцией красного, зелёного и синего. Все значения должны быть между 0 и 100.";
...
Blockly.Msg["NEW_COLOR_VARIABLE"] = "Создать переменную цвета...";
