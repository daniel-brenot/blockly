...
Blockly.Msg["COLOR_BLEND_COLOR1"] = "цвят 1";
Blockly.Msg["COLOR_BLEND_COLOR2"] = "цвят 2";
Blockly.Msg["COLOR_BLEND_HELPURL"] = "https://meyerweb.com/eric/tools/color-blend/#:::rgbp";  // untranslated
Blockly.Msg["COLOR_BLEND_RATIO"] = "съотношение";
Blockly.Msg["COLOR_BLEND_TITLE"] = "смеси";
Blockly.Msg["COLOR_BLEND_TOOLTIP"] = "Смесва два цвят в дадено съотношение (0.0 - 1.0).";
Blockly.Msg["COLOR_PICKER_HELPURL"] = "https://bg.wikipedia.org/wiki/Цвят_(оптика)";
Blockly.Msg["COLOR_PICKER_TOOLTIP"] = "Избери цвят от палитрата.";
Blockly.Msg["COLOR_RANDOM_HELPURL"] = "http://randomcolor.com";  // untranslated
Blockly.Msg["COLOR_RANDOM_TITLE"] = "случаен цвят";
Blockly.Msg["COLOR_RANDOM_TOOLTIP"] = "Избери цвят на случаен принцип.";
Blockly.Msg["COLOR_RGB_BLUE"] = "син";
Blockly.Msg["COLOR_RGB_GREEN"] = "зелен";
Blockly.Msg["COLOR_RGB_HELPURL"] = "https://www.december.com/html/spec/colorpercompact.html";  // untranslated
Blockly.Msg["COLOR_RGB_RED"] = "червен";
Blockly.Msg["COLOR_RGB_TITLE"] = "оцвети с";
Blockly.Msg["COLOR_RGB_TOOLTIP"] = "Създай цвят с избраните пропорции, червено, зелено и синьо. Всички стойности трябва да бъдат от 0 до 100.";
...
Blockly.Msg["NEW_COLOR_VARIABLE"] = "Създаване на цветова променлива...";
