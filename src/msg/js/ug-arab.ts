...
Blockly.Msg["COLOR_BLEND_COLOR1"] = "رەڭ 1";
Blockly.Msg["COLOR_BLEND_COLOR2"] = "رەڭ 2";
Blockly.Msg["COLOR_BLEND_HELPURL"] = "https://meyerweb.com/eric/tools/color-blend/#:::rgbp";  // untranslated
Blockly.Msg["COLOR_BLEND_RATIO"] = "نىسبەت";
Blockly.Msg["COLOR_BLEND_TITLE"] = "ئارىلاش";
Blockly.Msg["COLOR_BLEND_TOOLTIP"] = "Blends two colors together with a given ratio (0.0 - 1.0).";  // untranslated
Blockly.Msg["COLOR_PICKER_HELPURL"] = "https://zh.wikipedia.org/wiki/رەڭگى";
Blockly.Msg["COLOR_PICKER_TOOLTIP"] = " تاختىدىن رەڭنى تاللاڭ";
Blockly.Msg["COLOR_RANDOM_HELPURL"] = "http://randomcolor.com";  // untranslated
Blockly.Msg["COLOR_RANDOM_TITLE"] = "خالىغان رەڭ";
Blockly.Msg["COLOR_RANDOM_TOOLTIP"] = "ئىختىيارىي بىر رەڭنى تاللاڭ";
Blockly.Msg["COLOR_RGB_BLUE"] = "كۆك";
Blockly.Msg["COLOR_RGB_GREEN"] = "يېشىل";
Blockly.Msg["COLOR_RGB_HELPURL"] = "https://www.december.com/html/spec/colorpercompact.html";  // untranslated
Blockly.Msg["COLOR_RGB_RED"] = "قىزىل";
Blockly.Msg["COLOR_RGB_TITLE"] = "رەڭگى";
