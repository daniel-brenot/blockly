...
Blockly.Msg["COLOR_BLEND_RATIO"] = "nısbet";
Blockly.Msg["COLOR_BLEND_TITLE"] = "tewde";
Blockly.Msg["COLOR_BLEND_TOOLTIP"] = "Blends two colors together with a given ratio (0.0 - 1.0).";  // untranslated
Blockly.Msg["COLOR_PICKER_HELPURL"] = "https://diq.wikipedia.org/wiki/Reng";
Blockly.Msg["COLOR_PICKER_TOOLTIP"] = "Şıma palet ra yew reng weçinê.";
Blockly.Msg["COLOR_RANDOM_HELPURL"] = "http://randomcolor.com";  // untranslated
Blockly.Msg["COLOR_RANDOM_TITLE"] = "rengo rastameye";
Blockly.Msg["COLOR_RANDOM_TOOLTIP"] = "Tesadufi yu ren bıweçin";
Blockly.Msg["COLOR_RGB_BLUE"] = "kewe";
Blockly.Msg["COLOR_RGB_GREEN"] = "kıho";
Blockly.Msg["COLOR_RGB_HELPURL"] = "https://www.december.com/html/spec/colorpercompact.html";  // untranslated
Blockly.Msg["COLOR_RGB_RED"] = "sur";
Blockly.Msg["COLOR_RGB_TITLE"] = "komponentên rengan";
Blockly.Msg["COLOR_RGB_TOOLTIP"] = "Şıma renganê sûr, aşıl u kohoy ra rengê do spesifik vırazê. Gani ê pêro 0 u 100 miyan de bıbê.";
...
Blockly.Msg["NEW_COLOR_VARIABLE"] = "Vurriyayoğê rengi vıraze...";
