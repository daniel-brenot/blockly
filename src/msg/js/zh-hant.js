...
Blockly.Msg["COLOR_BLEND_COLOR1"] = "顏色 1";
Blockly.Msg["COLOR_BLEND_COLOR2"] = "顏色 2";
Blockly.Msg["COLOR_BLEND_HELPURL"] = "https://meyerweb.com/eric/tools/color-blend/#:::rgbp";  // untranslated
Blockly.Msg["COLOR_BLEND_RATIO"] = "比例";
Blockly.Msg["COLOR_BLEND_TITLE"] = "混合";
Blockly.Msg["COLOR_BLEND_TOOLTIP"] = "用一個給定的比率（0.0-1.0）混合兩種顏色。";
Blockly.Msg["COLOR_PICKER_HELPURL"] = "https://zh.wikipedia.org/wiki/顏色";
Blockly.Msg["COLOR_PICKER_TOOLTIP"] = "從調色板中選擇一種顏色。";
Blockly.Msg["COLOR_RANDOM_HELPURL"] = "http://randomcolor.com";  // untranslated
Blockly.Msg["COLOR_RANDOM_TITLE"] = "隨機顏色";
Blockly.Msg["COLOR_RANDOM_TOOLTIP"] = "隨機選擇一種顏色。";
Blockly.Msg["COLOR_RGB_BLUE"] = "藍";
Blockly.Msg["COLOR_RGB_GREEN"] = "綠";
Blockly.Msg["COLOR_RGB_HELPURL"] = "https://www.december.com/html/spec/colorpercompact.html";  // untranslated
Blockly.Msg["COLOR_RGB_RED"] = "紅";
Blockly.Msg["COLOR_RGB_TITLE"] = "顏色";
Blockly.Msg["COLOR_RGB_TOOLTIP"] = "透過指定紅、綠、 藍色的值來建立一種顏色。所有的值必須介於 0 和 100 之間。";
...
Blockly.Msg["NEW_COLOR_VARIABLE"] = "建立顏色變數…";
