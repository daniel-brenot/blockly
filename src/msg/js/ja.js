...
Blockly.Msg["COLOR_BLEND_COLOR1"] = "色 1";
Blockly.Msg["COLOR_BLEND_COLOR2"] = "色 2";
Blockly.Msg["COLOR_BLEND_HELPURL"] = "https://meyerweb.com/eric/tools/color-blend/#:::rgbp";
Blockly.Msg["COLOR_BLEND_RATIO"] = "比率";
Blockly.Msg["COLOR_BLEND_TITLE"] = "ブレンド";
Blockly.Msg["COLOR_BLEND_TOOLTIP"] = "2色を与えられた比率（0.0～1.0）で混ぜます。";
Blockly.Msg["COLOR_PICKER_HELPURL"] = "https://ja.wikipedia.org/wiki/色";
Blockly.Msg["COLOR_PICKER_TOOLTIP"] = "パレットから色を選んでください。";
Blockly.Msg["COLOR_RANDOM_HELPURL"] = "http://randomcolor.com";  // untranslated
Blockly.Msg["COLOR_RANDOM_TITLE"] = "ランダムな色";
Blockly.Msg["COLOR_RANDOM_TOOLTIP"] = "ランダムに色を選ぶ。";
Blockly.Msg["COLOR_RGB_BLUE"] = "青";
Blockly.Msg["COLOR_RGB_GREEN"] = "緑";
Blockly.Msg["COLOR_RGB_HELPURL"] = "https://www.december.com/html/spec/colorpercompact.html";
Blockly.Msg["COLOR_RGB_RED"] = "赤";
Blockly.Msg["COLOR_RGB_TITLE"] = "色:";
Blockly.Msg["COLOR_RGB_TOOLTIP"] = "赤、緑、および青の指定された量で色を作成します。すべての値は 0 ～ 100 の間でなければなりません。";
...
Blockly.Msg["NEW_COLOR_VARIABLE"] = "色の変数を作る...";
