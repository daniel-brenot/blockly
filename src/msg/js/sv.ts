...
Blockly.Msg["COLOR_BLEND_COLOR1"] = "färg 1";
Blockly.Msg["COLOR_BLEND_COLOR2"] = "färg 2";
Blockly.Msg["COLOR_BLEND_HELPURL"] = "https://meyerweb.com/eric/tools/color-blend/#:::rgbp";
Blockly.Msg["COLOR_BLEND_RATIO"] = "förhållande";
Blockly.Msg["COLOR_BLEND_TITLE"] = "blanda";
Blockly.Msg["COLOR_BLEND_TOOLTIP"] = "Blandar ihop två färger med ett bestämt förhållande (0.0 - 1.0).";
Blockly.Msg["COLOR_PICKER_HELPURL"] = "https://sv.wikipedia.org/wiki/Färg";
Blockly.Msg["COLOR_PICKER_TOOLTIP"] = "Välj en färg från paletten.";
Blockly.Msg["COLOR_RANDOM_HELPURL"] = "http://randomcolor.com";  // untranslated
Blockly.Msg["COLOR_RANDOM_TITLE"] = "slumpfärg";
Blockly.Msg["COLOR_RANDOM_TOOLTIP"] = "Slumpa fram en färg.";
Blockly.Msg["COLOR_RGB_BLUE"] = "blå";
Blockly.Msg["COLOR_RGB_GREEN"] = "grön";
Blockly.Msg["COLOR_RGB_HELPURL"] = "https://www.december.com/html/spec/colorpercompact.html";
Blockly.Msg["COLOR_RGB_RED"] = "röd";
Blockly.Msg["COLOR_RGB_TITLE"] = "färg med";
Blockly.Msg["COLOR_RGB_TOOLTIP"] = "Skapa en färg med det angivna mängden röd, grön och blå. Alla värden måste vara mellan 0 och 100.";
...
Blockly.Msg["NEW_COLOR_VARIABLE"] = "Skapa färgvariabel...";
