...
Blockly.Msg["COLOR_BLEND_COLOR1"] = "eezte Färv";
Blockly.Msg["COLOR_BLEND_COLOR2"] = "zwaite Färv";
Blockly.Msg["COLOR_BLEND_HELPURL"] = "https://meyerweb.com/eric/tools/color-blend/#:::rgbp";  // untranslated
Blockly.Msg["COLOR_BLEND_RATIO"] = "Verhhälltneß";
Blockly.Msg["COLOR_BLEND_TITLE"] = "blend";  // untranslated
Blockly.Msg["COLOR_BLEND_TOOLTIP"] = "Mesch zwai Färve med enem beschtempte Verhältneß (zwesche 0.0 un 1.0)";
...
Blockly.Msg["COLOR_RANDOM_TITLE"] = "en föhfälleje Färv";
Blockly.Msg["COLOR_RANDOM_TOOLTIP"] = "Söhg en Färv pä Zohfall uß.";
Blockly.Msg["COLOR_RGB_BLUE"] = "blou";
Blockly.Msg["COLOR_RGB_GREEN"] = "jröhn";
Blockly.Msg["COLOR_RGB_HELPURL"] = "https://www.december.com/html/spec/colorpercompact.html";  // untranslated
Blockly.Msg["COLOR_RGB_RED"] = "ruhd";
Blockly.Msg["COLOR_RGB_TITLE"] = "enfärve met";
