...
Blockly.Msg["COLOR_BLEND_COLOR1"] = "колер 1";
Blockly.Msg["COLOR_BLEND_COLOR2"] = "колер 2";
Blockly.Msg["COLOR_BLEND_HELPURL"] = "https://meyerweb.com/eric/tools/color-blend/#:::rgbp";  // untranslated
Blockly.Msg["COLOR_BLEND_RATIO"] = "дзеля";
Blockly.Msg["COLOR_BLEND_TITLE"] = "зьмяшаць";
Blockly.Msg["COLOR_BLEND_TOOLTIP"] = "Зьмешвае два колеры ў дадзенай прапорцыі (0.0 — 1.0)";
Blockly.Msg["COLOR_PICKER_HELPURL"] = "https://be-x-old.wikipedia.org/wiki/%D0%9A%D0%BE%D0%BB%D0%B5%D1%80";
Blockly.Msg["COLOR_PICKER_TOOLTIP"] = "Абярыце колер з палітры.";
Blockly.Msg["COLOR_RANDOM_HELPURL"] = "http://randomcolor.com";  // untranslated
Blockly.Msg["COLOR_RANDOM_TITLE"] = "выпадковы колер";
Blockly.Msg["COLOR_RANDOM_TOOLTIP"] = "Абраць выпадковы колер.";
Blockly.Msg["COLOR_RGB_BLUE"] = "сіняга";
Blockly.Msg["COLOR_RGB_GREEN"] = "зялёнага";
Blockly.Msg["COLOR_RGB_HELPURL"] = "https://www.december.com/html/spec/colorpercompact.html";  // untranslated
Blockly.Msg["COLOR_RGB_RED"] = "чырвонага";
Blockly.Msg["COLOR_RGB_TITLE"] = "колер з";
Blockly.Msg["COLOR_RGB_TOOLTIP"] = "Стварыць колер з абранымі прапорцыямі чырвонага, зялёнага і сіняга. Усе значэньні павінны быць ад 0 да 100.";
...
Blockly.Msg["NEW_COLOR_VARIABLE"] = "Стварыць зьменную колеру…";
