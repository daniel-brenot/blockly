...
Blockly.Msg["COLOR_BLEND_COLOR1"] = "color 1";  // untranslated
Blockly.Msg["COLOR_BLEND_COLOR2"] = "color 2";  // untranslated
Blockly.Msg["COLOR_BLEND_HELPURL"] = "https://meyerweb.com/eric/tools/color-blend/#:::rgbp";  // untranslated
Blockly.Msg["COLOR_BLEND_RATIO"] = "ratio";  // untranslated
Blockly.Msg["COLOR_BLEND_TITLE"] = "blend";  // untranslated
Blockly.Msg["COLOR_BLEND_TOOLTIP"] = "Blends two colors together with a given ratio (0.0 - 1.0).";  // untranslated
Blockly.Msg["COLOR_PICKER_HELPURL"] = "https://en.wikipedia.org/wiki/Color";  // untranslated
Blockly.Msg["COLOR_PICKER_TOOLTIP"] = "Choose a color from the palette.";  // untranslated
Blockly.Msg["COLOR_RANDOM_HELPURL"] = "http://randomcolor.com";  // untranslated
Blockly.Msg["COLOR_RANDOM_TITLE"] = "random color";  // untranslated
Blockly.Msg["COLOR_RANDOM_TOOLTIP"] = "Choose a color at random.";  // untranslated
Blockly.Msg["COLOR_RGB_BLUE"] = "blue";  // untranslated
Blockly.Msg["COLOR_RGB_GREEN"] = "green";  // untranslated
Blockly.Msg["COLOR_RGB_HELPURL"] = "https://www.december.com/html/spec/colorpercompact.html";  // untranslated
Blockly.Msg["COLOR_RGB_RED"] = "red";  // untranslated
Blockly.Msg["COLOR_RGB_TITLE"] = "color with";  // untranslated
Blockly.Msg["COLOR_RGB_TOOLTIP"] = "Create a color with the specified amount of red, green, and blue. All values must be between 0 and 100.";  // untranslated
...
Blockly.Msg["NEW_COLOR_VARIABLE"] = "Skep kleur veranderlike";
