...
Blockly.Msg["COLOR_BLEND_TOOLTIP"] = "Mistura duas cores em uma dada proporção (0,0 - 1,0).";
Blockly.Msg["COLOR_PICKER_HELPURL"] = "https://pt.wikipedia.org/wiki/Cor";
Blockly.Msg["COLOR_PICKER_TOOLTIP"] = "Escolher uma cor da palheta de cores.";
Blockly.Msg["COLOR_RANDOM_HELPURL"] = "http://randomcolor.com";  // untranslated
Blockly.Msg["COLOR_RANDOM_TITLE"] = "cor aleatória";
Blockly.Msg["COLOR_RANDOM_TOOLTIP"] = "Escolher cor de forma aleatória.";
...
Blockly.Msg["COLOR_RGB_TITLE"] = "colorir com";
Blockly.Msg["COLOR_RGB_TOOLTIP"] = "Criar uma cor com a quantidade especificada de vermelho, verde e azul. Todos os valores devem estar entre 0 e 100.";
