...
Blockly.Msg["COLOR_BLEND_COLOR1"] = "اللون 1";
Blockly.Msg["COLOR_BLEND_COLOR2"] = "اللون 2";
Blockly.Msg["COLOR_BLEND_HELPURL"] = "https://meyerweb.com/eric/tools/color-blend/#:::rgbp";
Blockly.Msg["COLOR_BLEND_RATIO"] = "نسبة";
Blockly.Msg["COLOR_BLEND_TITLE"] = "دمج";
Blockly.Msg["COLOR_BLEND_TOOLTIP"] = "دمج لونين ببعضهما البعض بنسبة (0.0 - 1.0).";
Blockly.Msg["COLOR_PICKER_HELPURL"] = "https://ar.wikipedia.org/wiki/Color";
Blockly.Msg["COLOR_PICKER_TOOLTIP"] = "اختر لون من اللوحة.";
Blockly.Msg["COLOR_RANDOM_HELPURL"] = "http://randomcolor.com";  // untranslated
Blockly.Msg["COLOR_RANDOM_TITLE"] = "لون عشوائي";
Blockly.Msg["COLOR_RANDOM_TOOLTIP"] = "اختر لون بشكل عشوائي.";
Blockly.Msg["COLOR_RGB_BLUE"] = "أزرق";
Blockly.Msg["COLOR_RGB_GREEN"] = "أخضر";
Blockly.Msg["COLOR_RGB_HELPURL"] = "https://www.december.com/html/spec/colorpercompact.html";
Blockly.Msg["COLOR_RGB_RED"] = "أحمر";
Blockly.Msg["COLOR_RGB_TITLE"] = "لون مع";
Blockly.Msg["COLOR_RGB_TOOLTIP"] = "إنشئ لون بالكمية المحددة من الأحمر, الأخضر والأزرق. بحيث يجب تكون كافة القيم بين 0 و 100.";
...
Blockly.Msg["NEW_COLOR_VARIABLE"] = "انشاء متغير لوني...";
