...
Blockly.Msg["COLOR_BLEND_COLOR1"] = "রং ১";
Blockly.Msg["COLOR_BLEND_COLOR2"] = "রং ২";
Blockly.Msg["COLOR_BLEND_HELPURL"] = "https://meyerweb.com/eric/tools/color-blend/#:::rgbp";  // untranslated
Blockly.Msg["COLOR_BLEND_RATIO"] = "অনুপাত";
Blockly.Msg["COLOR_BLEND_TITLE"] = "মিশ্রণ";
Blockly.Msg["COLOR_BLEND_TOOLTIP"] = "প্রদত্ত অনুপাত(০.০ - ১.০) অনুসারে দুটি রং একসাথে মিশ্রিত করুন।";
Blockly.Msg["COLOR_PICKER_HELPURL"] = "https://bn.wikipedia.org/wiki/রং";
Blockly.Msg["COLOR_PICKER_TOOLTIP"] = "প্যালেট থেকে একটি রং পছন্দ করুন";
Blockly.Msg["COLOR_RANDOM_HELPURL"] = "http://randomcolor.com";  // untranslated
Blockly.Msg["COLOR_RANDOM_TITLE"] = "এলোমেলো রং";
Blockly.Msg["COLOR_RANDOM_TOOLTIP"] = "এলোমেলোভাবে একটি রং পছন্দ করুন।";
Blockly.Msg["COLOR_RGB_BLUE"] = "নীল";
Blockly.Msg["COLOR_RGB_GREEN"] = "সবুজ";
Blockly.Msg["COLOR_RGB_HELPURL"] = "https://www.december.com/html/spec/colorpercompact.html";  // untranslated
Blockly.Msg["COLOR_RGB_RED"] = "লাল";
Blockly.Msg["COLOR_RGB_TITLE"] = "রং সহ";
Blockly.Msg["COLOR_RGB_TOOLTIP"] = "একটি রং তৈরি করুন নির্দিষ্ট পরিমাণে লাল, সবুজ এবং নীল রং মিশ্রিত করে। প্রত্যেকটির মান অবশ্যই ০ থেকে ১০০ এর মধ্যে হতে হবে।";
