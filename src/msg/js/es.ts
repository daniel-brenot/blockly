...
Blockly.Msg["COLOR_BLEND_TITLE"] = "combinar";
Blockly.Msg["COLOR_BLEND_TOOLTIP"] = "Combina dos colores con una proporción determinada (0,0-1,0).";
Blockly.Msg["COLOR_PICKER_HELPURL"] = "https://es.wikipedia.org/wiki/Color";
Blockly.Msg["COLOR_PICKER_TOOLTIP"] = "Elige un color de la paleta.";
Blockly.Msg["COLOR_RANDOM_HELPURL"] = "http://randomcolor.com";  // untranslated
Blockly.Msg["COLOR_RANDOM_TITLE"] = "color aleatorio";
Blockly.Msg["COLOR_RANDOM_TOOLTIP"] = "Elige un color al azar.";
...
Blockly.Msg["COLOR_RGB_RED"] = "rojo";
Blockly.Msg["COLOR_RGB_TITLE"] = "colorear con";
Blockly.Msg["COLOR_RGB_TOOLTIP"] = "Crea un color con cantidades específicas de rojo, verde y azul. Todos los valores deben encontrarse entre 0 y 100.";
...
Blockly.Msg["NEW_COLOR_VARIABLE"] = "Crear una variable de color...";
