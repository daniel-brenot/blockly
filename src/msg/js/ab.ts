...
Blockly.Msg["COLOR_BLEND_COLOR1"] = "аԥштәы 1";
Blockly.Msg["COLOR_BLEND_COLOR2"] = "аԥштәы 2";
Blockly.Msg["COLOR_BLEND_HELPURL"] = "https://meyerweb.com/eric/tools/color-blend/#:::rgbp";  // untranslated
Blockly.Msg["COLOR_BLEND_RATIO"] = "аԥштәы 1 ахәҭа";
Blockly.Msg["COLOR_BLEND_TITLE"] = "еилаҵатәуп";
Blockly.Msg["COLOR_BLEND_TOOLTIP"] = "Blends two colors together with a given ratio (0.0 - 1.0).";  // untranslated
Blockly.Msg["COLOR_PICKER_HELPURL"] = "https://ab.wikipedia.org/wiki/Аԥштәы";
Blockly.Msg["COLOR_PICKER_TOOLTIP"] = "Иалышәх аԥштәы";
Blockly.Msg["COLOR_RANDOM_HELPURL"] = "http://randomcolor.com";  // untranslated
Blockly.Msg["COLOR_RANDOM_TITLE"] = "иарбанзаалакь аԥштәы";
Blockly.Msg["COLOR_RANDOM_TOOLTIP"] = "Иалнахуеит аԥштәы машәыршақә";
Blockly.Msg["COLOR_RGB_BLUE"] = "жәҩангәԥштәы";
Blockly.Msg["COLOR_RGB_GREEN"] = "аиаҵәа";
Blockly.Msg["COLOR_RGB_HELPURL"] = "https://www.december.com/html/spec/colorpercompact.html";  // untranslated
Blockly.Msg["COLOR_RGB_RED"] = "аҟаԥшь";
Blockly.Msg["COLOR_RGB_TITLE"] = "аԥштәы аҟынтәи";
