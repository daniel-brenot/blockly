...
Blockly.Msg["COLOR_BLEND_RATIO"] = "сооднос";
Blockly.Msg["COLOR_BLEND_TITLE"] = "смешај";
Blockly.Msg["COLOR_BLEND_TOOLTIP"] = "Меша две бои во даден сооднос (0.0 - 1.0).";
Blockly.Msg["COLOR_PICKER_HELPURL"] = "https://mk.wikipedia.org/wiki/Боја";
Blockly.Msg["COLOR_PICKER_TOOLTIP"] = "Изберете боја од палетата.";
Blockly.Msg["COLOR_RANDOM_HELPURL"] = "http://randomcolor.com";  // untranslated
Blockly.Msg["COLOR_RANDOM_TITLE"] = "случајна боја";
Blockly.Msg["COLOR_RANDOM_TOOLTIP"] = "Избери боја на тепка.";
Blockly.Msg["COLOR_RGB_BLUE"] = "сина";
...
Blockly.Msg["COLOR_RGB_TITLE"] = "боја со";
Blockly.Msg["COLOR_RGB_TOOLTIP"] = "Создајте боја со укажаните износи на црвена, зелена и сина. Сите вредности мора да бидат помеѓу 0 и 100.";
