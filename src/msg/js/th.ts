...
Blockly.Msg["COLOR_BLEND_COLOR1"] = "สีที่ 1";
Blockly.Msg["COLOR_BLEND_COLOR2"] = "สีที่ 2";
Blockly.Msg["COLOR_BLEND_HELPURL"] = "https://meyerweb.com/eric/tools/color-blend/#:::rgbp";  // untranslated
Blockly.Msg["COLOR_BLEND_RATIO"] = "อัตราส่วน";
Blockly.Msg["COLOR_BLEND_TITLE"] = "ผสม";
Blockly.Msg["COLOR_BLEND_TOOLTIP"] = "ผสมสองสีเข้าด้วยกันด้วยอัตราส่วน (0.0 - 1.0)";
Blockly.Msg["COLOR_PICKER_HELPURL"] = "https://th.wikipedia.org/wiki/สี";
Blockly.Msg["COLOR_PICKER_TOOLTIP"] = "เลือกสีจากจานสี";
Blockly.Msg["COLOR_RANDOM_HELPURL"] = "http://randomcolor.com";  // untranslated
Blockly.Msg["COLOR_RANDOM_TITLE"] = "สุ่มสี";
Blockly.Msg["COLOR_RANDOM_TOOLTIP"] = "เลือกสีแบบสุ่ม";
Blockly.Msg["COLOR_RGB_BLUE"] = "ค่าสีน้ำเงิน";
Blockly.Msg["COLOR_RGB_GREEN"] = "ค่าสีเขียว";
Blockly.Msg["COLOR_RGB_HELPURL"] = "https://www.december.com/html/spec/colorpercompact.html";  // untranslated
Blockly.Msg["COLOR_RGB_RED"] = "ค่าสีแดง";
Blockly.Msg["COLOR_RGB_TITLE"] = "สีที่ประกอบด้วย";
Blockly.Msg["COLOR_RGB_TOOLTIP"] = "สร้างสีด้วยการกำหนดค่าสีแดง เขียว และน้ำเงิน ค่าทั้งหมดต้องอยู่ระหว่าง 0 ถึง 100";
...
Blockly.Msg["NEW_COLOR_VARIABLE"] = "สร้างตัวแปรสี";
