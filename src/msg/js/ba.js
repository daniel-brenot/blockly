...
Blockly.Msg["COLOR_BLEND_COLOR1"] = "1-се төҫ";
Blockly.Msg["COLOR_BLEND_COLOR2"] = "2-се төҫ";
Blockly.Msg["COLOR_BLEND_HELPURL"] = "https://meyerweb.com/eric/tools/color-blend/#:::rgbp";  // untranslated
Blockly.Msg["COLOR_BLEND_RATIO"] = "1-се төҫтөң өлөшө";
Blockly.Msg["COLOR_BLEND_TITLE"] = "ҡатнаштырырға";
Blockly.Msg["COLOR_BLEND_TOOLTIP"] = "Ике төҫтө бирелгән нисбәттә болғата (0.0 - 1.0).";
Blockly.Msg["COLOR_PICKER_HELPURL"] = "https://en.wikipedia.org/wiki/Төҫ";
Blockly.Msg["COLOR_PICKER_TOOLTIP"] = "Палитранан төҫ һайлағыҙ.";
Blockly.Msg["COLOR_RANDOM_HELPURL"] = "http://randomcolor.com";  // untranslated
Blockly.Msg["COLOR_RANDOM_TITLE"] = "осраҡлы төҫ";
Blockly.Msg["COLOR_RANDOM_TOOLTIP"] = "Төҫтө осраҡлылыҡ буйынса һайлай.";
Blockly.Msg["COLOR_RGB_BLUE"] = "зәңгәр";
Blockly.Msg["COLOR_RGB_GREEN"] = "йәшелдән";
Blockly.Msg["COLOR_RGB_HELPURL"] = "https://www.december.com/html/spec/colorpercompact.html";  // untranslated
Blockly.Msg["COLOR_RGB_RED"] = "ҡыҙылдан";
Blockly.Msg["COLOR_RGB_TITLE"] = "ошонан төҫ";
Blockly.Msg["COLOR_RGB_TOOLTIP"] = "Бирелгән нисбәттәрҙә ҡыҙылдан, йәшелдән һәм зәңгәрҙән төҫ барлыҡҡа килә. Бөтә мәғәнәләр 0 менән 100 араһында булырға тейеш.";
