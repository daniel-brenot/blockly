...
Blockly.Msg["COLOR_BLEND_COLOR1"] = "1-түс";
Blockly.Msg["COLOR_BLEND_COLOR2"] = "2-түс";
Blockly.Msg["COLOR_BLEND_HELPURL"] = "https://meyerweb.com/eric/tools/color-blend/#:::rgbp";  // untranslated
Blockly.Msg["COLOR_BLEND_RATIO"] = "катышы";
Blockly.Msg["COLOR_BLEND_TITLE"] = "аралаштыруу";
Blockly.Msg["COLOR_BLEND_TOOLTIP"] = "Эки түстү берилген катыш (0.0 - 1.0) менен аралаштыр.";
Blockly.Msg["COLOR_PICKER_HELPURL"] = "https://en.wikipedia.org/wiki/Color";
Blockly.Msg["COLOR_PICKER_TOOLTIP"] = "палитрадан түс танда";
Blockly.Msg["COLOR_RANDOM_HELPURL"] = "http://randomcolor.com";  // untranslated
Blockly.Msg["COLOR_RANDOM_TITLE"] = "тушкелди түс";
Blockly.Msg["COLOR_RANDOM_TOOLTIP"] = "Түстү тушкелди тандоо.";
Blockly.Msg["COLOR_RGB_BLUE"] = "көк";
Blockly.Msg["COLOR_RGB_GREEN"] = "жашыл";
Blockly.Msg["COLOR_RGB_HELPURL"] = "https://www.december.com/html/spec/colorpercompact.html";  // untranslated
Blockly.Msg["COLOR_RGB_RED"] = "кызыл";
Blockly.Msg["COLOR_RGB_TITLE"] = "түсү менен";
Blockly.Msg["COLOR_RGB_TOOLTIP"] = "Кызыл, жашыл жана көк түстөрдөн жаңы түс жаса. Ар бир түстүн мааниси 0 менен 100 арасында болуусу керек.";
