...
Blockly.Msg["COLOR_BLEND_COLOR1"] = "颜色1";
Blockly.Msg["COLOR_BLEND_COLOR2"] = "颜色2";
...
Blockly.Msg["COLOR_BLEND_TOOLTIP"] = "把两种颜色以一个给定的比例(0.0-1.0)进行混合。";
Blockly.Msg["COLOR_PICKER_HELPURL"] = "https://zh.wikipedia.org/wiki/颜色";
Blockly.Msg["COLOR_PICKER_TOOLTIP"] = "从调色板中选择一种颜色。";
Blockly.Msg["COLOR_RANDOM_HELPURL"] = "http://randomcolor.com";  // untranslated
Blockly.Msg["COLOR_RANDOM_TITLE"] = "随机颜色";
Blockly.Msg["COLOR_RANDOM_TOOLTIP"] = "随机选择一种颜色。";
Blockly.Msg["COLOR_RGB_BLUE"] = "蓝色";
Blockly.Msg["COLOR_RGB_GREEN"] = "绿色";
Blockly.Msg["COLOR_RGB_HELPURL"] = "https://www.december.com/html/spec/colorpercompact.html";  // untranslated
Blockly.Msg["COLOR_RGB_RED"] = "红色";
Blockly.Msg["COLOR_RGB_TITLE"] = "颜色";
Blockly.Msg["COLOR_RGB_TOOLTIP"] = "通过指定红色、绿色和蓝色的量创建一种颜色。所有的值必须在0和100之间。";
...
Blockly.Msg["NEW_COLOR_VARIABLE"] = "创建颜色变量...";
