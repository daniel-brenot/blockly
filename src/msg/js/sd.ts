...
Blockly.Msg["COLOR_BLEND_RATIO"] = "تناسب";
Blockly.Msg["COLOR_BLEND_TITLE"] = "گڏيل";
Blockly.Msg["COLOR_BLEND_TOOLTIP"] = "ڄاڻايل تناسب سان ٻہ رنگ پاڻ ۾ ملايو (0.0-1.0).";
Blockly.Msg["COLOR_PICKER_HELPURL"] = "https://en.wikipedia.org/wiki/Color";
Blockly.Msg["COLOR_PICKER_TOOLTIP"] = "رنگ دٻيءَ مان رنگ چونڊيو.";
Blockly.Msg["COLOR_RANDOM_HELPURL"] = "http://randomcolor.com";  // untranslated
Blockly.Msg["COLOR_RANDOM_TITLE"] = "بنا ترتيب رنگ";
Blockly.Msg["COLOR_RANDOM_TOOLTIP"] = "ڪو بہ ‌رنگ چونڊيو.";
Blockly.Msg["COLOR_RGB_BLUE"] = "نيرو";
Blockly.Msg["COLOR_RGB_GREEN"] = "سائو";
Blockly.Msg["COLOR_RGB_HELPURL"] = "https://www.december.com/html/spec/colorpercompact.html";  // untranslated
Blockly.Msg["COLOR_RGB_RED"] = "ڳاڙهو";
Blockly.Msg["COLOR_RGB_TITLE"] = "سان رڱيو";
Blockly.Msg["COLOR_RGB_TOOLTIP"] = "ڳاڙهي، سائي، ۽ نيري جو مقدار ڄاڻائي گھربل رنگ ٺاهيو. سمورا قدر 0 ۽ 100 جي وچ ۾ هجن.";
